...
class DefaultTrainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, sample in enumerate(self.data_loader):
            ...
            # get network output
            # (N, C, H, W) GPU tensor
            P_A_pred, P_T_pred, T_pred = self.model(I_alpha, I, delta_I)
            ...
            model_loss = self.loss(P_A_pred, P_A, P_T_pred, P_T, T_pred, T)
            model_loss.backward()
            self.optimizer.step()
            ...
            total_metrics += self._eval_metrics(T_pred, T)
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            for batch_idx, sample in enumerate(self.valid_data_loader):
                ...
                loss = self.loss(P_A_pred, P_A, P_T_pred, P_T, T_pred, T)
